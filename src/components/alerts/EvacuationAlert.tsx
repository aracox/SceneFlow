...
export default function EvacuationAlert() {
  ...
  return (
    <div className="pointer-events-none absolute left-1/2 top-5 z-30 w-[min(460px,calc(100%-32px))] -translate-x-1/2">
      <div className="pointer-events-auto overflow-hidden rounded-3xl border border-white/55 bg-white/62 shadow-[0_18px_48px_rgba(146,64,14,0.18)] backdrop-blur-2xl ring-1 ring-amber-100/60">
        <div className="flex items-start gap-4 border-l-[6px] border-amber-500/90 p-4">
          <div className="mt-0.5 flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-amber-50/85 text-amber-600 shadow-[0_8px_22px_rgba(245,158,11,0.12)]">
